        ...
        <div class="row gy-4">
          <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center" data-aos="zoom-out">
            ...
            <div class="d-flex">
              ...
              <a href="https://visitstore.bio/dell?tab=ig" class="glightbox btn-watch-video d-flex align-items-center"><i class="bi bi-play-circle"></i><span>Visit Store</span></a>
            </div>
          </div>
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-7 d-flex flex-column justify-content-center order-2 order-lg-1">
            ...
            <div class="content px-xl-5" data-aos="fade-up" data-aos-delay="100">
              <h3><span>The XPS 14 is back and better than ever </span><strong>@dell_official</strong></h3>
              <p>
          ...
          <div class="col-lg-5 order-1 order-lg-2 why-us-img">
            <img src="\assets\img\Dell Laptop.jpg" class="img-fluid" alt="" data-aos="zoom-in" data-aos-delay="100">
          </div>
        </div>
